//defining variables
{var player;
var spike, gaps, walls, collisionWalls, enemy;
var border;
...
function setup() {
  ...
  collisionWalls = createSprite(walls.x+29.5, walls.y, 1, 50);
}
//the game
function draw() {
  ...
  if(gameState == "start"){
    ...
    textSize(20);
    fill("grey")
    text("[Press Space to start]", 200, 240)
    text("[Press the up or down arrow key to change gravity]", 200, 280)
  }
  //starting the game
